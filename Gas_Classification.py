...
if __name__ == "__main__":
    ...
    for classes, gas in zip(keep_classes_by_gas, ["CO2", "O3", "N2"]):
        ...
        GC.compute_feature_subset_accuracy(use_aggregated_ranking=False, max_features=10, save=True, keep_classes=classes, gas=gas)
        multivariate_path = (
        ...
        GC.compute_feature_subset_accuracy(ranked_features_path=multivariate_path, max_features=10, save=True,
